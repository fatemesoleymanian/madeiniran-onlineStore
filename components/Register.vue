<template>
  <div>
    <i class="fa fa-arrow-right text-right"
       ...
       aria-hidden="true"
       @click="$store.dispatch('setFlag', true)">
    ...
    <div class="form">
      ...
      <input v-model="data.code" type="text" name="user-name" maxlength="5"
             placeholder="" style="text-align: center;font-size: 25px" @keyup.enter="confirm">
      <div>
        <span class="text-muted text-center " v-if="!end" style="float: right">{{ countDown }} ثانیه</span>
