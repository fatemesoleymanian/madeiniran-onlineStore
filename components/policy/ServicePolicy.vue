                ...
                <div class="col-md-6 col-sm-12 mt-30">
                    <div class="support-wrap support-1">
                        <div class="support-content">
                          ...
                          <h6 class="d-flex float-start more-info px-2 py-1">
                            <router-link to="/about" class=" text-white ">اطلاعات بیشتر...</router-link>
                          </h6>
                        </div>
                    </div>
                </div>
              <div class="col-md-6 col-sm-12 text-center ">
                <div class=" text-center">
                  <div class="support-icon">
                    <img class="animated"
                         src="../../static/img/banner/about.png" alt="about-us">
                  </div>
