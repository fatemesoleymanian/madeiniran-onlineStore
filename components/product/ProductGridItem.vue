    ...
    <div class="product-img">
      ...
      >
        <div class="pro-same-action pro-wishlist">
          ...
          >
            <i
              :class="checkIsLiked === true ? 'fa fa-heart' : 'pe-7s-like'"
            ></i>
          </button>
        </div>
    ...
    <div class="product-content text-center">
      ...
      <div class="product-price" v-if="auth && states.length">
        <span style="font-family: persianNumber"
          >{{
            product.state[0].discounted_price.replace(
              /\B(?=(\d{3})+(?!\d))/g,
              ","
            )
          }}
        ...
        <span
          ...
          >{{
            product.state[0].price.replace(/\B(?=(\d{3})+(?!\d))/g, ",")
          }}تومان</span
        >
      </div>
        ...
        <div class="pro-action d-flex align-items-center">
          ...
          <div class="pro-wishlist">
            <button @click="addToWishlist(product)">
              <i
                :class="checkIsLiked === true ? 'fa fa-heart' : 'fa fa-heart-o'"
              ></i>
            </button>
          </div>
        </div>
