              ...
              <div class="container">
                <div class="description-review-wrapper">
                  ...
                  <div class="tab-content description-review-bottom">
                                  ...
                                  <div class="col-md-12 text-center ">
                                    <div class="rating-form-style mb-10 ">
                                      <input placeholder="نام و نام خانوادگی :"
                                             type="text" v-model="new_ideas.full_name">
                                    </div>
                                  </div>
                                  <div class="col-md-12 ">
                                    <div class="rating-form-style mb-10">
                                  ...
                                  <div class="col-md-12 ">
                                    <div class="rating-form-style form-submit">
                                                <textarea v-model="new_ideas.description"
                                                          name="Your Review"
                                                          placeholder="ایده مدنظر یا درخواست ایده تولیدی:"></textarea>
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="col-md-12 text-center">
                                    <div class="rating-form-style form-submit py-3">
                                      <input type="submit"
                                             :value="new_ideas.saving ? 'در حال ارسال اطلاعات' : 'ارسال اطلاعات'"
                    ...
                    <div id="empty-ideas" class="tab-pane text-center text-center">
                      <div class="row">
                        <div class="col-12 text-center">
                          <div class="ratting-form-wrapper px-2" id="form-empty">
                            <div class="ratting-form py-3 text-center">
                              <form class="text-center w-100">
                                <div class="row text-center">
                                  <div class="col-md-12 text-center">
                                  ...
                                  <div class="col-12">
                                    <select class="form-select text-end form-select-sm w-100"
                                ...
                                <div class="row">
                                  <div class="col-md-12 text-center">
                                    <div class="rating-form-style form-submit py-3">
                                      <input type="submit"
                                             :value="empty_ideas.saving ? 'در حال ارسال اطلاعات' : 'ارسال اطلاعات'"
