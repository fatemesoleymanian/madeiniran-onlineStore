<template>
    <ul>
      <li>
        <n-link to="/">صفحه اصلی</n-link>
      </li>
      <li>
        <n-link to="/">دپارتمان ها <i class="fa fa-angle-down"></i></n-link>
        <ul class="submenu">
          <li>
            <n-link to="/">فنی</n-link>
          </li>
          <li>
            <n-link to="/">خدمات پس از فروش و پشتیبانی</n-link>
          </li>
          <li>
            <n-link to="/">آموزش</n-link>
          </li>
          <li>
            <n-link to="/">بازاریابی و فروش</n-link>
          </li>

          <li>
            <n-link to="/">کسب و کار</n-link>
          </li>
        </ul>
      </li>
      <li>
...
<!--        </li>-->
<!--        <li>-->
<!--            <n-link to="/shop"> دپارتمان ها <i class="fa fa-angle-down"></i></n-link>-->
<!--            <ul class="mega-menu">-->
<!--                <li>-->
<!--                    <ul>-->
<!--                        <li class="mega-menu-title">-->
...
<!--        </li>-->
<!--        <li>-->
<!--            <n-link to="">محصولات <i class="fa fa-angle-down"></i></n-link>-->
<!--            <ul class="submenu">-->
...
<!--        </li>-->
<!--        <li>-->
<!--            <n-link to="/blog">وبلاگ <i class="fa fa-angle-down"></i></n-link>-->
<!--            <ul class="submenu">-->
<!--                <li>-->
