    ...
    <div class="container p-5 my-5 border" style="border-radius: 5px">
      <div class="row my-5">
        <div class="col-md-2 pb-sm-3">
          <h3
            class="d-flex justify-content-center py-5 text-dark"
        ...
        <div class="col-md-10">
          <div
            class="review-wrapper rounded bg-gray"
            style="border-top: 1px solid #0b4dfc"
            v-for="(c, i) in product_comments"
            :key="i"
            v-if="product_comments"
          >
            <div class="row text-center fw-bold py-4 my-2">
              ...
              <div class="col-3">
                <h5>ایجاد در {{ c.created_at }}</h5>
              </div>
              <div class="col-3">
                <p>{{ c.status ? "تایید شده" : "هنوز تایید نشده" }}</p>
              </div>
              <div class="col-3">
                <p>
                  <a style="color: #0b4dfc" :href="`/product/${c.product_id}`">
                    مشاهده محصول
                  </a>
                </p>
              </div>
            ...
            <div class="row text-center fw-bold py-4 my-2">
              ...
              <div class="col-3">
                <p>
                  <a
                    style="color: #0b4dfc"
                    :href="`https://madein-iran.com/blog/${c.blog_id}/`"
                  >
                    مشاهده پست
                  </a>
                </p>
