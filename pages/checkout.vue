            ...
            <div class="billing-info-wrap">
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="billing-info mb-20">
                    <label>طبقه</label>
                    <input type="number" v-model="user_info.floor" min="0" title="برای همکف 0 را وارد کنید."
                           placeholder="برای همکف 0 را وارد کنید.">
                  </div>
                </div>
                <div class="col-lg-6 col-md-6">
                  <div class="billing-info mb-20">
                  ...
                  <div class="your-order-middle">
                    <ul>
                      <li v-for="(product, index) in order_items" :key="index">
                        ...
                        <span class="order-price" style="font-family:persianNumber;">
                                                {{
