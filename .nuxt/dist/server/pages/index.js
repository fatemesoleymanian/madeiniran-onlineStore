...
//
//
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({components:{NewsletterStyleOne: NewsletterStyleOne["default"],TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 60)),HeroSlider:()=>__webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, 105)),ServicePolicy:()=>__webpack_require__.e(/* import() */ 3).then(__webpack_require__.bind(null, 158)),ProductWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 71)),BlogWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 66)),TestimonialOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 67)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},head(){return{title:'فروشگاه ساخت ایران'};}});
