exports.ids = [72,0,7,8,16,19,28,37,43,51,54,55];
exports.modules = {
...
//
//
/* harmony default export */ var HeroSlidervue_type_script_lang_js_ = ({data(){return{swiperOption:{loop:true,speed:750,slidesPerView:1,spaceBetween:10,autoplay:{delay:6000},effect:"fade",fadeEffect:{crossFade:true},navigation:{nextEl:'.swiper-button-next',prevEl:'.swiper-button-prev'}}};}});
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=4383a487&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"home-page-wrapper"},[_c('TheHeader'),_vm._ssrNode(" "),_c('HeroSlider'),_vm._ssrNode(" "),_c('ServicePolicy'),_vm._ssrNode(" "),_c('ProductWrapper',{attrs:{"isSectionTitle":true}}),_vm._ssrNode(" "),_c('BlogWrapper'),_vm._ssrNode(" "),_c('TestimonialOne'),_vm._ssrNode(" "),_c('NewsletterStyleOne'),_vm._ssrNode(" "),_c('TheFooter')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=4383a487&

// EXTERNAL MODULE: ./components/NewsletterStyleOne.vue + 4 modules
var NewsletterStyleOne = __webpack_require__(65);
...
//
//
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({components:{NewsletterStyleOne: NewsletterStyleOne["default"],TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 60)),HeroSlider:()=>__webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, 106)),ServicePolicy:()=>__webpack_require__.e(/* import() */ 3).then(__webpack_require__.bind(null, 85)),ProductWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 71)),BlogWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 66)),TestimonialOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 67)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},head(){return{title:'فروشگاه ساخت ایران'};}});
...
installComponents(component, {TheHeader: __webpack_require__(60).default,HeroSlider: __webpack_require__(113).default,ProductWrapper: __webpack_require__(71).default,BlogWrapper: __webpack_require__(66).default,TestimonialOne: __webpack_require__(67).default,NewsletterStyleOne: __webpack_require__(65).default,TheFooter: __webpack_require__(53).default})
