...
//
//
/* harmony default export */ var home_fashion_sixvue_type_script_lang_js_ = ({components:{HeaderOffcanvasMenuWithTransparent:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 103)),HeroSliderSix:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 104)),WelcomeMessage:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 68)),ProductWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 71)),NewsletterStyleOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 65)),InstagramPostWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 105)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},head(){return{title:'Home Fashion Six'};}});
...
/* nuxt-component-imports */
installComponents(component, {HeaderOffcanvasMenuWithTransparent: __webpack_require__(103).default,HeroSliderSix: __webpack_require__(104).default,WelcomeMessage: __webpack_require__(68).default,ProductWrapper: __webpack_require__(71).default,NewsletterStyleOne: __webpack_require__(65).default,InstagramPostWrapper: __webpack_require__(105).default,TheFooter: __webpack_require__(53).default})
