...
//
//
/* harmony default export */ var home_fashion_sevenvue_type_script_lang_js_ = ({components:{HeaderWithTopbar:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 57)),HeroSliderSeven:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 100)),ProductWrapperSeven:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 101)),BannerStyleThree:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 116)),DealWithCountdown:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 102)),ServicePolicyThree:()=>__webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, 159)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},head(){return{title:'Home Fashion Seven'};}});
...
/* nuxt-component-imports */
installComponents(component, {HeaderWithTopbar: __webpack_require__(57).default,HeroSliderSeven: __webpack_require__(100).default,ProductWrapperSeven: __webpack_require__(101).default,BannerStyleThree: __webpack_require__(116).default,DealWithCountdown: __webpack_require__(102).default,NewsletterStyleOne: __webpack_require__(65).default,TheFooter: __webpack_require__(53).default})
