exports.ids = [79,7,8,20,27,52,55];
exports.modules = {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_shop_vue_vue_type_style_index_0_id_a2b4abbe_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(80);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_shop_vue_vue_type_style_index_0_id_a2b4abbe_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_shop_vue_vue_type_style_index_0_id_a2b4abbe_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_shop_vue_vue_type_style_index_0_id_a2b4abbe_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_shop_vue_vue_type_style_index_0_id_a2b4abbe_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/shop.vue?vue&type=template&id=a2b4abbe&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"shop-page-wrapper"},[_c('HeaderWithTopbar',{attrs:{"containerClass":"container"}}),_vm._ssrNode(" "),_c('Breadcrumb',{attrs:{"pageTitle":"لیست محصولات"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"shop-area pt-100 pb-100\" data-v-a2b4abbe>","</div>",[_vm._ssrNode("<div class=\"container\" data-v-a2b4abbe>","</div>",[_vm._ssrNode("<div class=\"row flex-row-reverse\" data-v-a2b4abbe>","</div>",[_vm._ssrNode("<div class=\"col-lg-9\" data-v-a2b4abbe>","</div>",[_vm._ssrNode("<div class=\"shop-top-bar\" data-v-a2b4abbe>","</div>",[_vm._ssrNode("<div class=\"select-showing-wrap\" data-v-a2b4abbe>","</div>",[_vm._ssrNode("<div class=\"shop-select\" data-v-a2b4abbe>","</div>",[_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.selectedPrice),expression:"selectedPrice"}],on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.selectedPrice=$event.target.multiple ? $$selectedVal : $$selectedVal[0]}}},[_c('option',{attrs:{"value":"new","label":"جدید ترین"}},[_vm._v("جدید ترین")]),_vm._v(" "),_c('option',{attrs:{"value":"old","label":"قدیمی ترین"}},[_vm._v("قدیمی ترین")]),_vm._v(" "),_c('option',{attrs:{"value":"expensive","label":"گران ترین"}},[_vm._v("گران ترین")]),_vm._v(" "),_c('option',{attrs:{"value":"cheap","label":"ارزانترین"}},[_vm._v("ارزانترین")])])]),_vm._ssrNode(" <p data-v-a2b4abbe>"+_vm._ssrEscape("مشاهده "+_vm._s(_vm.perPage * _vm.currentPage - _vm.perPage + 1)+" تا "+_vm._s(_vm.perPage * _vm.currentPage > _vm.filterItems.length ? _vm.filterItems.length : _vm.perPage * _vm.currentPage)+" از "+_vm._s(_vm.filterItems.length)+" نتیجه")+"</p>")],2),_vm._ssrNode(" <div class=\"shop-tab\" data-v-a2b4abbe><button"+(_vm._ssrClass(null,{ active : _vm.layout === 'twoColumn' }))+" data-v-a2b4abbe><i class=\"fa fa-th-large\" data-v-a2b4abbe></i></button> <button"+(_vm._ssrClass(null,{ active : _vm.layout === 'threeColumn' }))+" data-v-a2b4abbe><i class=\"fa fa-th\" data-v-a2b4abbe></i></button> <button"+(_vm._ssrClass(null,{ active : _vm.layout === 'list' }))+" data-v-a2b4abbe><i class=\"fa fa-list-ul\" data-v-a2b4abbe></i></button></div>")],2),_vm._ssrNode(" "+((_vm.loader)?("<div id=\"loading\" data-v-a2b4abbe></div>"):"<!---->")+" "),(!_vm.loader)?_vm._ssrNode("<div class=\"shop-bottom-area mt-35\" data-v-a2b4abbe>","</div>",[_vm._ssrNode("<div"+(_vm._ssrClass("row product-layout",{ 'list': _vm.layout === 'list', 'grid three-column': _vm.layout === 'threeColumn', 'grid two-column': _vm.layout === 'twoColumn' }))+" data-v-a2b4abbe>","</div>",_vm._l((_vm.getItems),function(product,index){return _vm._ssrNode("<div class=\"col-xl-4 col-sm-6\" data-v-a2b4abbe>","</div>",[_c('ProductGridItem',{attrs:{"product":product,"layout":_vm.layout}})],1)}),0)]):_vm._e(),_vm._ssrNode(" "),(_vm.getPaginateCount > 1 )?_vm._ssrNode("<div data-v-a2b4abbe>","</div>",[_c('pagination',{staticClass:"pro-pagination-style shop-pagination mt-30",attrs:{"per-page":_vm.perPage,"records":_vm.filterItems.length,"page-count":_vm.getPaginateCount},on:{"paginate":_vm.paginateClickCallback},model:{value:(_vm.currentPage),callback:function ($$v) {_vm.currentPage=$$v},expression:"currentPage"}})],1):_vm._e()],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-lg-3\" data-v-a2b4abbe>","</div>",[_c('ShopSidebar',{attrs:{"classes":"mr-30"}})],1)],2)])]),_vm._ssrNode(" "),_c('QuickView'),_vm._ssrNode(" "),_c('TheFooter')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/shop.vue?vue&type=template&id=a2b4abbe&scoped=true&
...
//
//
/* harmony default export */ var shopvue_type_script_lang_js_ = ({components:{HeaderWithTopbar:()=>__webpack_require__.e(/* import() */ 0).then(__webpack_require__.bind(null, 60)),Breadcrumb:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 56)),ProductGridItem:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 59)),QuickView:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 55)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},data(){return{loader:true,layout:"threeColumn",filterItems:[],prevSelectedCategoryName:'',prevSelectedTagName:'',prevSelectedSizeName:'',prevSelectedColorName:'',currentPage:1,perPage:10,selectedPrice:'new'};},computed:{products(){return this.$store.getters.getProducts;},getItems(){let start=(this.currentPage-1)*this.perPage;let end=this.currentPage*this.perPage;return this.filterItems.slice(start,end);},getPaginateCount(){return Math.ceil(this.filterItems.length/this.perPage);}},async mounted(){this.loader=true;const[products,categories,tags]=await Promise.all([this.$axios.get('/products'),this.$axios.get('/categories'),this.$axios.get('/tags_with_product')]);this.$store.dispatch('setProduct',products.data);this.$store.dispatch('setCategory',categories.data);this.$store.dispatch('setTags',tags.data);let states=[];for(let s in products.data){for(let t in products.data[s].state){if(!states.includes(products.data[s].state[t].type))states.push(products.data[s].state[t].type);}}this.$store.dispatch('setState',states);this.updateProductData();this.loader=false;},methods:{paginateClickCallback(page){this.currentPage=Number(page);},updateProductData(){this.paginateClickCallback(1);const categoryName=this.$route.query.category;const stateName=this.$route.query.state;const tagName=this.$route.query.tag;if(Object.keys(this.$route.query).length===0){this.filterItems=[...this.products];}if(categoryName&&this.prevSelectedCategoryName!==categoryName){if(Boolean(categoryName)===false||categoryName==='all'){this.filterItems=[...this.products];}else{const resultData=this.products.filter(item=>item.category.id==categoryName);this.filterItems=[];this.filterItems.push(...resultData);}}if(stateName&&this.prevSelectedColorName!==stateName){if(Boolean(stateName)===false||stateName==='all'){this.filterItems=[...this.products];}else{const resultData=this.products.filter(item=>{return item.state.some(n=>{return n.type.includes(stateName);});});this.filterItems=[];this.filterItems.push(...resultData);}}if(tagName&&this.prevSelectedTagName!==tagName){if(tagName){const resultData=this.products.filter(item=>{return item.tag.some(n=>{return n.id==tagName;});});this.filterItems=[];this.filterItems.push(...resultData);}if(Boolean(tagName)===false||tagName==='all'){this.filterItems=[...this.products];}}this.prevSelectedCategoryName=categoryName;this.prevSelectedStateName=stateName;this.prevSelectedTagName=tagName;},discountedPrice(product){return product.state[0].price;},id(product){return product.id;}},watch:{$route(){this.updateProductData();},selectedPrice(){console.log(this.selectedPrice);switch(this.selectedPrice){case"new":this.filterItems=[...this.products];break;case"old":this.filterItems=this.filterItems.sort((a,b)=>this.id(a)-this.id(b));break;case"expensive":this.filterItems=this.filterItems.sort((a,b)=>this.discountedPrice(b)-this.discountedPrice(a));break;case"cheap":this.filterItems=this.filterItems.sort((a,b)=>this.discountedPrice(a)-this.discountedPrice(b));break;default:this.filterItems=[...this.products];}}},head(){return{title:"لیست محصولات"};}});
