...
//
//
/* harmony default export */ var ProductWrapperFourvue_type_script_lang_js_ = ({components:{ProductGridStyleThree:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 73)),QuickView:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 57))},computed:{products(){return this.$store.getters.getProducts;}}});
...
installComponents(component, {ProductGridStyleThree: __webpack_require__(73).default,QuickView: __webpack_require__(57).default})
...
//
//
/* harmony default export */ var home_fashion_fourvue_type_script_lang_js_ = ({components:{HeaderLogoCenterWithTransparent:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 98)),HeroSliderFour:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 99)),ProductWrapperFour:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 100)),NewsletterStyleOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 67)),FooterStyleTwo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 101))},head(){return{title:'Home Fashion Four'};}});
...
/* nuxt-component-imports */
installComponents(component, {HeaderLogoCenterWithTransparent: __webpack_require__(98).default,HeroSliderFour: __webpack_require__(99).default,ProductWrapperFour: __webpack_require__(100).default,NewsletterStyleOne: __webpack_require__(67).default,FooterStyleTwo: __webpack_require__(101).default})
