...
//
//
/* harmony default export */ var shop_grid_no_sidebarvue_type_script_lang_js_ = ({components:{HeaderWithTopbar:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 60)),Breadcrumb:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 59)),ProductGridItem:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 63)),QuickView:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 58)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 55))},data(){return{layout:"threeColumn",currentPage:1,perPage:9};},computed:{products(){return this.$store.getters.getProducts;},getItems(){let start=(this.currentPage-1)*this.perPage;let end=this.currentPage*this.perPage;return this.products.slice(start,end);},getPaginateCount(){return Math.ceil(this.products.length/this.perPage);}},methods:{paginateClickCallback(page){this.currentPage=Number(page);}},head(){return{title:"Shop grid no sidebar"};}});
...
installComponents(component, {HeaderWithTopbar: __webpack_require__(60).default,Breadcrumb: __webpack_require__(59).default,ProductGridItem: __webpack_require__(63).default,QuickView: __webpack_require__(58).default,TheFooter: __webpack_require__(55).default})
