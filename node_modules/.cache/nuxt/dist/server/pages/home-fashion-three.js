exports.ids = [71,0,2,8,16,19,42,49,52,56];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/hero/HeroSliderThree.vue?vue&type=template&id=2aebdab3&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"slider-area nav-style-1"},[_c('swiper',{attrs:{"options":_vm.swiperOption}},[_vm._l((_vm.sliderData),function(slider,index){return _c('swiper-slide',{key:index,staticClass:"single-slider-2 slider-height-2 d-flex align-items-center bg-img",style:({ backgroundImage:("url(https://api.madein-iran.com/public" + (slider.image) + ")") })},[_c('div',{staticClass:"container"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-lg-7 col-md-8 ms-auto"},[_c('div',{staticClass:"slider-content-3 slider-animation-1 text-center"},[_c('h3',{directives:[{name:"show",rawName:"v-show",value:(slider.sub_title),expression:"slider.sub_title"}]},[_vm._v(_vm._s(slider.sub_title))]),_vm._v(" "),_c('h1',{directives:[{name:"show",rawName:"v-show",value:(slider.title),expression:"slider.title"}]},[_vm._v(_vm._s(slider.title))]),_vm._v(" "),_c('p',{directives:[{name:"show",rawName:"v-show",value:(slider.text),expression:"slider.text"}]},[_vm._v(_vm._s(slider.text))]),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(slider.link),expression:"slider.link"}],staticClass:"slider-btn btn-hover"},[_c('a',{directives:[{name:"show",rawName:"v-show",value:(slider.link),expression:"slider.link"}],attrs:{"href":slider.link}},[_vm._v(_vm._s(slider.button_content))])])])])])])])}),_vm._v(" "),_c('div',{staticClass:"hero-slider-nav swiper-button-prev"},[_c('i',{staticClass:"pe-7s-angle-left"})]),_vm._v(" "),_c('div',{staticClass:"hero-slider-nav swiper-button-next"},[_c('i',{staticClass:"pe-7s-angle-right"})])],2)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/hero/HeroSliderThree.vue?vue&type=template&id=2aebdab3&
...
//
//
/* harmony default export */ var ProductWrapperThreevue_type_script_lang_js_ = ({components:{ProductGridItemTwo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 64)),QuickView:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 58))},computed:{products(){return this.$store.getters.getProducts;}}});
...
//
//
/* harmony default export */ var home_fashion_threevue_type_script_lang_js_ = ({components:{TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 62)),HeroSliderThree:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 108)),ServicePolicyTwo:()=>__webpack_require__.e(/* import() */ 6).then(__webpack_require__.bind(null, 164)),ProductWrapperThree:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 109)),BlogWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 70)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 55))},head(){return{title:'home-fashion-three'};}});
...
/* nuxt-component-imports */
installComponents(component, {TheHeader: __webpack_require__(62).default,HeroSliderThree: __webpack_require__(108).default,ProductWrapperThree: __webpack_require__(109).default,BlogWrapper: __webpack_require__(70).default,TheFooter: __webpack_require__(55).default})
