exports.ids = [73,0,2,8,16,19,42,49,52,56];
exports.modules = {
...
//
//
/* harmony default export */ var ProductWrapperThreevue_type_script_lang_js_ = ({components:{ProductGridItemTwo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 64)),QuickView:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 59))},computed:{products(){return this.$store.getters.getProducts;}}});
...
installComponents(component, {SectionTitleWithSubTitle: __webpack_require__(61).default,ProductGridItemTwo: __webpack_require__(64).default,QuickView: __webpack_require__(59).default})
...
//
//
/* harmony default export */ var home_fashion_threevue_type_script_lang_js_ = ({components:{TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 62)),HeroSliderThree:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 110)),ServicePolicyTwo:()=>__webpack_require__.e(/* import() */ 6).then(__webpack_require__.bind(null, 171)),ProductWrapperThree:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 111)),BlogWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 70)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 55))},head(){return{title:'home-fashion-three'};}});
