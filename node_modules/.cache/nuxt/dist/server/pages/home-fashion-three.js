...
//
//
/* harmony default export */ var ProductWrapperThreevue_type_script_lang_js_ = ({components:{ProductGridItemTwo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 63)),QuickView:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 57))},computed:{products(){return this.$store.getters.getProducts;}}});
...
//
//
/* harmony default export */ var home_fashion_threevue_type_script_lang_js_ = ({components:{TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 62)),HeroSliderThree:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 109)),ServicePolicyTwo:()=>__webpack_require__.e(/* import() */ 6).then(__webpack_require__.bind(null, 167)),ProductWrapperThree:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 110)),BlogWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 69)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 54))},head(){return{title:'home-fashion-three'};}});
...
/* nuxt-component-imports */
installComponents(component, {TheHeader: __webpack_require__(62).default,HeroSliderThree: __webpack_require__(109).default,ProductWrapperThree: __webpack_require__(110).default,BlogWrapper: __webpack_require__(69).default,TheFooter: __webpack_require__(54).default})
