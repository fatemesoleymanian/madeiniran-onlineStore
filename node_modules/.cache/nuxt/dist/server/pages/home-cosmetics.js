...
//
//
/* harmony default export */ var home_cosmeticsvue_type_script_lang_js_ = ({components:{TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 60)),HeroSliderCosmetics:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 89)),ProductWrapperCosmetics:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 90)),ServicePolicyFour:()=>__webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, 160)),TestimonialOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 67)),BrandLogoCarousel:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 92)),BlogWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 66)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},head(){return{title:'Home Cosmetics'};}});
