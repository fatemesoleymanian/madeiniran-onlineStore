...
//
//
/* harmony default export */ var home_cosmeticsvue_type_script_lang_js_ = ({components:{TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 60)),HeroSliderCosmetics:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 87)),ProductWrapperCosmetics:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 88)),ServicePolicyFour:()=>__webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, 159)),TestimonialOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 67)),BrandLogoCarousel:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 90)),BlogWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 66)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},head(){return{title:'Home Cosmetics'};}});
...
installComponents(component, {TheHeader: __webpack_require__(60).default,HeroSliderCosmetics: __webpack_require__(87).default,ProductWrapperCosmetics: __webpack_require__(88).default,TestimonialOne: __webpack_require__(67).default,BannerStyleFour: __webpack_require__(89).default,BrandLogoCarousel: __webpack_require__(90).default,BlogWrapper: __webpack_require__(66).default,TheFooter: __webpack_require__(53).default})
