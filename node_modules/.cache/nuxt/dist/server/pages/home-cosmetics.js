exports.ids = [67,0,1,8,11,12,16,19,29,41,44,51,54,55];
exports.modules = {
...
//
//
/* harmony default export */ var home_cosmeticsvue_type_script_lang_js_ = ({components:{TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 60)),HeroSliderCosmetics:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 89)),ProductWrapperCosmetics:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 90)),ServicePolicyFour:()=>__webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, 162)),TestimonialOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 69)),BrandLogoCarousel:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 92)),BlogWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 67)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},head(){return{title:'Home Cosmetics'};}});
...
/* nuxt-component-imports */
installComponents(component, {BannerItem: __webpack_require__(63).default})
