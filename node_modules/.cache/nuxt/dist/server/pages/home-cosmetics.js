...
//
//
/* harmony default export */ var home_cosmeticsvue_type_script_lang_js_ = ({components:{TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 60)),HeroSliderCosmetics:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 89)),ProductWrapperCosmetics:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 90)),ServicePolicyFour:()=>__webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, 163)),TestimonialOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 69)),BrandLogoCarousel:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 92)),BlogWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 67)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},head(){return{title:'Home Cosmetics'};}});
...
installComponents(component, {TheHeader: __webpack_require__(60).default,HeroSliderCosmetics: __webpack_require__(89).default,ProductWrapperCosmetics: __webpack_require__(90).default,TestimonialOne: __webpack_require__(69).default,BannerStyleFour: __webpack_require__(91).default,BrandLogoCarousel: __webpack_require__(92).default,BlogWrapper: __webpack_require__(67).default,TheFooter: __webpack_require__(53).default})
