...
var TestimonialOne = __webpack_require__(69);

// EXTERNAL MODULE: ./components/policy/ServicePolicy.vue + 4 modules
var ServicePolicy = __webpack_require__(86);
...
AboutMission:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 87)),// TeamMembers: () => import('@/components/TeamMembers'),
BrandLogoCarousel:()=>__webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(null, 92)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},data(){return{items:[]};},async mounted(){await this.$axios.get('departments').then(res=>{this.items=res.data;});},head(){return{title:"درباره ما"};}});
...
installComponents(component, {HeaderWithTopbar: __webpack_require__(57).default,Breadcrumb: __webpack_require__(56).default,AboutMission: __webpack_require__(87).default,TestimonialOne: __webpack_require__(69).default,NewsletterStyleOne: __webpack_require__(65).default,TheFooter: __webpack_require__(53).default})
