...
//
//
/* harmony default export */ var home_fashion_twovue_type_script_lang_js_ = ({components:{TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 60)),HeroSliderTwo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 109)),BannerStyleOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 110)),ProductWrapperTwo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 111)),BlogWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 67)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},head(){return{title:'Home Fashion Two'};}});
...
/* nuxt-component-imports */
installComponents(component, {TheHeader: __webpack_require__(60).default,HeroSliderTwo: __webpack_require__(109).default,BannerStyleOne: __webpack_require__(110).default,ProductWrapperTwo: __webpack_require__(111).default,BlogWrapper: __webpack_require__(67).default,TheFooter: __webpack_require__(53).default})
