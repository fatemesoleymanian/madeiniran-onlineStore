...
//
//
/* harmony default export */ var ProductWrapperTwovue_type_script_lang_js_ = ({components:{ProductGridItemTwo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 63)),QuickView:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 57))},computed:{newProducts(){return this.$store.getters.getNewProducts;},bestProducts(){return this.$store.getters.getBestProducts;},saleProducts(){return this.$store.getters.getSaleProducts;}}});
...
//
//
/* harmony default export */ var home_fashion_twovue_type_script_lang_js_ = ({components:{TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 62)),HeroSliderTwo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 111)),BannerStyleOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 112)),ProductWrapperTwo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 113)),BlogWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 69)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 54))},head(){return{title:'Home Fashion Two'};}});
...
/* nuxt-component-imports */
installComponents(component, {TheHeader: __webpack_require__(62).default,HeroSliderTwo: __webpack_require__(111).default,BannerStyleOne: __webpack_require__(112).default,ProductWrapperTwo: __webpack_require__(113).default,BlogWrapper: __webpack_require__(69).default,TheFooter: __webpack_require__(54).default})
