...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_b036f5ba_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(75);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_b036f5ba_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_b036f5ba_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_b036f5ba_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_b036f5ba_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/index.vue?vue&type=template&id=b036f5ba&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"blog-page-wrapper"},[_c('TheHeader',{attrs:{"containerClass":"container"}}),_vm._ssrNode(" "),_c('Breadcrumb',{attrs:{"pageTitle":"وبلاگ"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"blog-area pt-100 pb-100\" data-v-b036f5ba>","</div>",[_vm._ssrNode("<div class=\"container\" data-v-b036f5ba>","</div>",[_vm._ssrNode(((_vm.loader)?("<div id=\"loading\" data-v-b036f5ba></div>"):"<!---->")+" "),_vm._ssrNode("<div class=\"row flex-row-reverse\" data-v-b036f5ba>","</div>",[_vm._ssrNode("<div class=\"col-lg-9\" data-v-b036f5ba>","</div>",[_vm._ssrNode("<div class=\"ml-20\" data-v-b036f5ba>","</div>",[_vm._ssrNode("<div class=\"row\" data-v-b036f5ba>","</div>",_vm._l((_vm.getBlog),function(blog,index){return _vm._ssrNode("<div class=\"col-md-6 col-12\" data-v-b036f5ba>","</div>",[_c('BlogItemStyleTwo',{attrs:{"blog":blog}})],1)}),0)]),_vm._ssrNode(" "),(_vm.getPaginateCount > 1)?_vm._ssrNode("<div data-v-b036f5ba>","</div>",[_c('pagination',{staticClass:"pro-pagination-style shop-pagination mt-30",attrs:{"per-page":_vm.perPage,"records":_vm.total,"page-count":_vm.getPaginateCount},on:{"paginate":_vm.paginateClickCallback},model:{value:(_vm.currentPage),callback:function ($$v) {_vm.currentPage=$$v},expression:"currentPage"}})],1):_vm._e()],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-lg-3\" data-v-b036f5ba>","</div>",[_c('BlogSidebar')],1)],2)],2)]),_vm._ssrNode(" "),_c('TheFooter')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/blog/index.vue?vue&type=template&id=b036f5ba&scoped=true&
...
//
//
/* harmony default export */ var blogvue_type_script_lang_js_ = ({components:{TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 60)),BlogItemStyleTwo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 69)),BlogSidebar:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 87)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},data(){return{blogs:this.$store.getters.getBlogs,response:'',currentPage:1,perPage:6,total:1,loader:true};},computed:{getBlog(){return this.$store.getters.getBlogs;},getItems(){let start=(datal.data.current_page-1)*datal.data.per_page;let end=datal.data.current_page*datal.data.per_page;return datal.data.data.slice(start,end);},getPaginateCount(){return Math.ceil(this.total/this.perPage);}},methods:{async paginateClickCallback(page){this.loader=true;let datal=await this.$axios.get(`blogs?page=${page}`);localStorage.setItem('blogs',datal.data.data);this.$store.dispatch('updateBlogs',datal.data.data);this.currentPage=Number(page);this.loader=false;}},async mounted(){this.loader=true;let datal=await this.$axios.get('blogs');localStorage.setItem('blogs',datal.data.data);this.$store.dispatch('updateBlogs',datal.data.data);this.response=datal.data;this.currentPage=this.response.current_page;this.perPage=this.response.per_page;this.total=this.response.total;this.loader=false;},head(){return{title:"وبلاگ "};}});
...
installComponents(component, {TheHeader: __webpack_require__(60).default,Breadcrumb: __webpack_require__(56).default,BlogItemStyleTwo: __webpack_require__(69).default,BlogSidebar: __webpack_require__(87).default,TheFooter: __webpack_require__(53).default})
