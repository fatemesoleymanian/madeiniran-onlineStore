...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_3d84f5c9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(83);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_3d84f5c9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_3d84f5c9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_3d84f5c9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_3d84f5c9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/_slug.vue?vue&type=template&id=3d84f5c9&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"product-details-page-wrapper"},[_c('TheHeader',{attrs:{"containerClass":"container"}}),_vm._ssrNode(" "),_c('Breadcrumb',{attrs:{"pageTitle":_vm.blogs.title}}),_vm._ssrNode(" <div class=\"Blog-details-inner pt-100 pb-100\" data-v-3d84f5c9><div class=\"container\" data-v-3d84f5c9><div class=\"row flex-row-reverse\" data-v-3d84f5c9><div class=\"col-lg-12\" data-v-3d84f5c9>"+((_vm.loader)?("<div id=\"loading\" data-v-3d84f5c9></div>"):"<!---->")+" <div class=\"blog-details-wrapper ml-20\" data-v-3d84f5c9>"+((!_vm.loader)?("<div class=\"blog-details-top\" data-v-3d84f5c9><div class=\"blog-details-img\" data-v-3d84f5c9><img"+(_vm._ssrAttr("src",'https://apidemo.madein-iran.com/public'+_vm.blogs.featuredImage))+(_vm._ssrAttr("alt",_vm.blogs.title))+" data-v-3d84f5c9></div> <div class=\"blog-details-content\" data-v-3d84f5c9><div class=\"blog-meta-2\" data-v-3d84f5c9><ul data-v-3d84f5c9><li data-v-3d84f5c9>"+_vm._ssrEscape(_vm._s(_vm.blogs.updated_at))+"</li></ul></div> <h3 data-v-3d84f5c9>"+_vm._ssrEscape(_vm._s(_vm.blogs.title))+"</h3> <div data-v-3d84f5c9>"+(_vm._s(_vm.blogs.post))+"</div></div></div>"):"<!---->")+" "+((_vm.blogs)?("<div class=\"tag-share\" data-v-3d84f5c9><div class=\"dec-tag\" data-v-3d84f5c9>"+(_vm._ssrList((_vm.blogs.tag),function(tag,i){return (((_vm.blogs.tag.length)?("<ul data-v-3d84f5c9><li data-v-3d84f5c9>"+_vm._ssrEscape(_vm._s(tag.name))+"</li></ul>"):"<!---->"))}))+"</div> <div class=\"blog-share\" data-v-3d84f5c9><div class=\"share-social\" data-v-3d84f5c9><ul data-v-3d84f5c9><li data-v-3d84f5c9><a class=\"twitter\" data-v-3d84f5c9><i aria-hidden=\"true\" class=\"fa fa-share\" data-v-3d84f5c9></i></a></li></ul></div></div></div>"):"<!---->")+" "+((_vm.blogs.length === 0)?("<div data-v-3d84f5c9><h3 class=\"text-center p-5\" data-v-3d84f5c9>پستی یافت نشد!</h3></div>"):"<!---->")+" <div class=\"next-previous-post\" data-v-3d84f5c9>"+((_vm.before)?("<a"+(_vm._ssrAttr("href",("/blog/" + _vm.before)))+" data-v-3d84f5c9><i class=\"fa fa-angle-right\" data-v-3d84f5c9></i>  پست قبل\n                            </a>"):"<!---->")+" "+((_vm.after)?("<a"+(_vm._ssrAttr("href",("/blog/" + _vm.after)))+" data-v-3d84f5c9>\n                            پست بعد <i class=\"fa fa-angle-left\" data-v-3d84f5c9></i></a>"):"<!---->")+"</div></div></div></div></div></div> "),_c('TheFooter')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/blog/_slug.vue?vue&type=template&id=3d84f5c9&scoped=true&
...
//
//
/* harmony default export */ var _slugvue_type_script_lang_js_ = ({data(){return{blogs:[],id:this.$route.params.slug,before:'',after:'',loader:true};},async mounted(){this.loader=true;const blog=await this.$axios.get(`blogs/${this.id}`);this.blogs=blog.data;this.loader=false;},async created(){const id=await this.$axios.get(`blogs_id/${this.id}`);if(id.data.after)this.after=id.data.after.id;if(id.data.before)this.before=id.data.before.id;},methods:{copyToClipboard(){navigator.clipboard.writeText(`https://madein-iran/blog/${this.id}.com`).then(()=>{this.$notify({title:'لینک بلاگ کپی شد!',type:'success'});}).catch(()=>{this.$notify({title:'خطا در کپی لینک بلاگ!',type:'error'});});}},head(){return{title:this.blogs.title};}});
