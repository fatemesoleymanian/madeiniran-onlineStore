...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_d2cf6196_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(84);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_d2cf6196_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_d2cf6196_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_d2cf6196_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_1_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_d2cf6196_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/_slug.vue?vue&type=template&id=d2cf6196&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"product-details-page-wrapper"},[_c('TheHeader',{attrs:{"containerClass":"container"}}),_vm._ssrNode(" "),_c('Breadcrumb',{attrs:{"pageTitle":_vm.blogs.title}}),_vm._ssrNode(" <div class=\"Blog-details-inner pt-100 pb-100 px-4\" data-v-d2cf6196><div class=\"container\" data-v-d2cf6196><div class=\"row flex-row-reverse px-2\" data-v-d2cf6196><div class=\"col-lg-12\" data-v-d2cf6196>"+((_vm.loader)?("<div id=\"loading\" data-v-d2cf6196></div>"):"<!---->")+" <div class=\"blog-details-wrapper ml-20\" data-v-d2cf6196>"+((!_vm.loader)?("<div class=\"blog-details-top\" data-v-d2cf6196><div class=\"blog-details-img\" data-v-d2cf6196><img"+(_vm._ssrAttr("src",'https://apidemo.madein-iran.com/public'+_vm.blogs.featuredImage))+(_vm._ssrAttr("alt",_vm.blogs.title))+" data-v-d2cf6196></div> <div class=\"blog-details-content\" data-v-d2cf6196><div class=\"blog-meta-2\" data-v-d2cf6196><ul data-v-d2cf6196><li data-v-d2cf6196>"+_vm._ssrEscape(_vm._s(_vm.blogs.updated_at))+"</li></ul></div> <h3 data-v-d2cf6196>"+_vm._ssrEscape(_vm._s(_vm.blogs.title))+"</h3> <div data-v-d2cf6196>"+(_vm._s(_vm.blogs.post))+"</div></div></div>"):"<!---->")+" "+((_vm.blogs)?("<div class=\"tag-share\" data-v-d2cf6196><div class=\"dec-tag\" data-v-d2cf6196>"+(_vm._ssrList((_vm.blogs.tag),function(tag,i){return (((_vm.blogs.tag.length)?("<ul data-v-d2cf6196><li data-v-d2cf6196>"+_vm._ssrEscape(_vm._s(tag.name))+"</li></ul>"):"<!---->"))}))+"</div> <div class=\"blog-share\" data-v-d2cf6196><div class=\"share-social\" data-v-d2cf6196><ul data-v-d2cf6196><li data-v-d2cf6196><a class=\"twitter\" data-v-d2cf6196><i aria-hidden=\"true\" class=\"fa fa-share\" data-v-d2cf6196></i></a></li></ul></div></div></div>"):"<!---->")+" "+((_vm.blogs.length === 0)?("<div data-v-d2cf6196><h3 class=\"text-center p-5\" data-v-d2cf6196>پستی یافت نشد!</h3></div>"):"<!---->")+" <div class=\"next-previous-post\" data-v-d2cf6196>"+((_vm.before)?("<a"+(_vm._ssrAttr("href",("/blog/" + _vm.before)))+" data-v-d2cf6196><i class=\"fa fa-angle-right\" data-v-d2cf6196></i>  پست قبل\n                            </a>"):"<!---->")+" "+((_vm.after)?("<a"+(_vm._ssrAttr("href",("/blog/" + _vm.after)))+" data-v-d2cf6196>\n                            پست بعد <i class=\"fa fa-angle-left\" data-v-d2cf6196></i></a>"):"<!---->")+"</div></div></div></div></div></div> "),_c('TheFooter')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/blog/_slug.vue?vue&type=template&id=d2cf6196&scoped=true&
...
//
//
/* harmony default export */ var _slugvue_type_script_lang_js_ = ({data(){return{blogs:[],id:this.$route.params.slug,before:'',after:'',loader:true};},async created(){this.loader=true;const[blog,id]=await Promise.all([this.$axios.get(`blogs/${this.id}`),this.$axios.get(`blogs_id/${this.id}`)]);this.blogs=blog.data;if(id.data.after)this.after=id.data.after.id;if(id.data.before)this.before=id.data.before.id;this.loader=false;},methods:{copyToClipboard(){navigator.clipboard.writeText(`https://madein-iran/blog/${this.id}.com`).then(()=>{this.$notify({title:'لینک پست کپی شد!',type:'success'});}).catch(()=>{this.$notify({title:'خطا در کپی لینک پست!',type:'error'});});}},head(){return{title:this.blogs.title};}});
