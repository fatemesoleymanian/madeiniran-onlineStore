...
//
//
/* harmony default export */ var home_fashion_sevenvue_type_script_lang_js_ = ({components:{HeaderWithTopbar:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 57)),HeroSliderSeven:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 98)),ProductWrapperSeven:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 99)),BannerStyleThree:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 114)),DealWithCountdown:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 100)),ServicePolicyThree:()=>__webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, 160)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},head(){return{title:'Home Fashion Seven'};}});
