...
//
//
/* harmony default export */ var home_fashion_sixvue_type_script_lang_js_ = ({components:{HeaderOffcanvasMenuWithTransparent:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 105)),HeroSliderSix:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 106)),WelcomeMessage:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 107)),ProductWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 74)),NewsletterStyleOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 67)),InstagramPostWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 108)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 54))},head(){return{title:'Home Fashion Six'};}});
...
/* nuxt-component-imports */
installComponents(component, {HeaderOffcanvasMenuWithTransparent: __webpack_require__(105).default,HeroSliderSix: __webpack_require__(106).default,WelcomeMessage: __webpack_require__(107).default,ProductWrapper: __webpack_require__(74).default,NewsletterStyleOne: __webpack_require__(67).default,InstagramPostWrapper: __webpack_require__(108).default,TheFooter: __webpack_require__(54).default})
