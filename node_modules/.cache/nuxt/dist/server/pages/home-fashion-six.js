...
//
//
/* harmony default export */ var home_fashion_sixvue_type_script_lang_js_ = ({components:{HeaderOffcanvasMenuWithTransparent:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 106)),HeroSliderSix:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 107)),WelcomeMessage:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 108)),ProductWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 76)),NewsletterStyleOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 68)),InstagramPostWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 109)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 55))},head(){return{title:'Home Fashion Six'};}});
...
/* nuxt-component-imports */
installComponents(component, {HeaderOffcanvasMenuWithTransparent: __webpack_require__(106).default,HeroSliderSix: __webpack_require__(107).default,WelcomeMessage: __webpack_require__(108).default,ProductWrapper: __webpack_require__(76).default,NewsletterStyleOne: __webpack_require__(68).default,InstagramPostWrapper: __webpack_require__(109).default,TheFooter: __webpack_require__(55).default})
