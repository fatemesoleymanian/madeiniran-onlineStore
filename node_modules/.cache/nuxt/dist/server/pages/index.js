...
//
//
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({components:{NewslettersPopup:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 116)),TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 62)),HeroSlider:()=>__webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, 109)),ServicePolicy:()=>__webpack_require__.e(/* import() */ 3).then(__webpack_require__.bind(null, 88)),ProductWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 74)),BlogWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 69)),TestimonialOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 71)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 54)),NewsletterStyleOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 67))},head(){return{title:'راه اندازی انواع کسب و کار تولیدی',meta:[{hid:'فروشگاه خط تولید',name:'فروشگاه ساخت ایران',content:'فروشگاه خط تولید ساخت ایران'}]};}});
...
installComponents(component, {NewslettersPopup: __webpack_require__(116).default,TheHeader: __webpack_require__(62).default,HeroSlider: __webpack_require__(117).default,ProductWrapper: __webpack_require__(74).default,BlogWrapper: __webpack_require__(69).default,TestimonialOne: __webpack_require__(71).default,NewsletterStyleOne: __webpack_require__(67).default,TheFooter: __webpack_require__(54).default})
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/TheHeader.vue?vue&type=template&id=2ea72562&
...
// CONCATENATED MODULE: ./components/TheHeader.vue?vue&type=template&id=2ea72562&
...
//
//
/* harmony default export */ var BlogWrappervue_type_script_lang_js_ = ({components:{BlogItem:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 68))},data(){return{blogs:[]};},async mounted(){const blog=await this.$axios.get('/blogs-random');this.blogs=blog.data;}});
...
/* nuxt-component-imports */
installComponents(component, {SectionTitleWithSubTitle: __webpack_require__(60).default,BlogItem: __webpack_require__(68).default})
...
//
//
/* harmony default export */ var ProductWrappervue_type_script_lang_js_ = ({props:['isSectionTitle'],async mounted(){const products=await this.$axios.get('/products_random');this.latestProducts=products.data;},components:{ProductGridItem:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 61)),QuickView:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 57))},data(){return{layout:"twoColumn",latestProducts:[]};}});
...
/* nuxt-component-imports */
installComponents(component, {SectionTitleWithSubTitle: __webpack_require__(60).default,ProductGridItem: __webpack_require__(61).default,QuickView: __webpack_require__(57).default})
