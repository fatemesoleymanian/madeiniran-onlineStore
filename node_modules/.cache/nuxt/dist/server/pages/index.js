...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/newslettersPopup.vue?vue&type=template&id=55dcd4d7&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<button type=\"button\" data-bs-toggle=\"modal\" data-bs-target=\"#exampleModal\" hidden=\"hidden\" id=\"newsletterPopUpButton\" class=\"btn btn-primary\" data-v-55dcd4d7></button> <div id=\"exampleModal\" tabindex=\"-1\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\" data-keyboard=\"false\" data-backdrop=\"static\" class=\"modal \" data-v-55dcd4d7><div class=\"modal-dialog modal-dialog-centered\" data-v-55dcd4d7><div class=\"modal-content\" data-v-55dcd4d7><div class=\"modal-header\" data-v-55dcd4d7><h5 id=\"exampleModalLabel\" class=\"modal-title float-end ml-auto fw-bolder\" style=\"margin-left: auto;\" data-v-55dcd4d7> ثبت\n            نام در\n            خبرنامه</h5> <button type=\"button\" data-bs-dismiss=\"modal\" aria-label=\"Close\" class=\"btn-close float-start\" style=\"margin-right: auto;margin-left: -10px\" data-v-55dcd4d7></button></div> <div class=\"modal-body\" data-v-55dcd4d7><form data-v-55dcd4d7><p data-v-55dcd4d7>با ثبت‌نام در خبرنامه هر دو ماه یک بار با ارائه خطوط تولید جدید، شما می‌‌توانید از طریق دریافت پیامک،\n              در جریان جزئیات قرار بگیرید.</p> <div class=\"mb-3\" data-v-55dcd4d7><label for=\"recipient-name\" class=\"col-form-label\" data-v-55dcd4d7>نام و نام خانوادگی:</label> <input type=\"text\" id=\"recipient-name\""+(_vm._ssrAttr("value",(_vm.informationObj.full_name)))+" class=\"form-control\" data-v-55dcd4d7></div> <div class=\"mb-3\" data-v-55dcd4d7><label for=\"phonenumber\" class=\"col-form-label\" data-v-55dcd4d7>شماره تلفن همراه:</label> <input type=\"tel\" id=\"phonenumber\""+(_vm._ssrAttr("value",(_vm.informationObj.phone_number)))+" class=\"form-control\" data-v-55dcd4d7></div></form></div> <div class=\"modal-footer\" data-v-55dcd4d7><button type=\"button\""+(_vm._ssrAttr("disabled",_vm.makeButtonLoading))+(_vm._ssrAttr("loading",_vm.makeButtonLoading))+" class=\"btn btn-primary\" data-v-55dcd4d7>"+_vm._ssrEscape("\n            "+_vm._s(!_vm.makeButtonLoading ? 'ثبت نام' : 'کمی صبر کنید...')+"\n          ")+"</button></div></div></div></div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/newslettersPopup.vue?vue&type=template&id=55dcd4d7&scoped=true&
...
//
//
/* harmony default export */ var newslettersPopupvue_type_script_lang_js_ = ({name:"newslettersPopup",data(){return{informationObj:{full_name:'',phone_number:''},makeButtonLoading:false};},methods:{async checkAndRegisterInNewsletter(e){e.preventDefault();if(this.informationObj.full_name.trim()==='')return this.$notify({title:"خطا!",text:'لطفا نام و نام خانوادگی خود را وارد کنید.',type:'error'});if(this.informationObj.phone_number.trim()==='')return this.$notify({title:"خطا!",text:'لطفا شماره تلفن همراه خود را وارد کنید.',type:'error'});if(this.informationObj.phone_number.length!==11)return this.$notify({title:"خطا!",text:"لطفا شماره تلفن همراه خود رابه درستی وارد کنید.",type:'error'});this.makeButtonLoading=true;await this.$axios.post('/add_new_receiver',this.informationObj).then(response=>{this.makeButtonLoading=false;return this.$notify({title:"سپاس از مشارکت شما!",text:response.data.msg,type:'success'});}).catch(()=>{this.makeButtonLoading=false;return this.$notify({title:"عملیات ناموفق!",text:"خطایی در ثبت اطلاعات رخ داد.",type:'error'});});}},mounted(){console.log('k');document.getElementById('newsletterPopUpButton').click();}});
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/QuickView.vue?vue&type=template&id=4d93830c&
...
// CONCATENATED MODULE: ./components/QuickView.vue?vue&type=template&id=4d93830c&
