...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/newslettersPopup.vue?vue&type=template&id=3ce62402&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<button type=\"button\" data-bs-toggle=\"modal\" data-bs-target=\"#exampleModal\" hidden=\"hidden\" id=\"newsletterPopUpButton\" class=\"btn btn-primary\" data-v-3ce62402></button> <div id=\"exampleModal\" tabindex=\"-1\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\" data-keyboard=\"false\" data-backdrop=\"static\" class=\"modal \" data-v-3ce62402><div class=\"modal-dialog modal-dialog-centered\" data-v-3ce62402><div class=\"modal-content\" data-v-3ce62402><div class=\"modal-header\" data-v-3ce62402><h5 id=\"exampleModalLabel\" class=\"modal-title float-end ml-auto fw-bolder\" style=\"margin-left: auto;\" data-v-3ce62402> ثبت\n            نام در\n            خبرنامه</h5> <button type=\"button\" data-bs-dismiss=\"modal\" aria-label=\"Close\" class=\"btn-close float-start\" style=\"margin-right: auto;margin-left: -10px\" data-v-3ce62402></button></div> <div class=\"modal-body\" data-v-3ce62402><form data-v-3ce62402><p data-v-3ce62402>با ثبت‌نام در خبرنامه هر دو ماه یک بار با ارائه خطوط تولید جدید، شما می‌‌توانید از طریق دریافت پیامک،\n              در جریان جزئیات قرار بگیرید.</p> <div class=\"mb-3\" data-v-3ce62402><label for=\"recipient-name\" class=\"col-form-label\" data-v-3ce62402>نام و نام خانوادگی:</label> <input type=\"text\" id=\"recipient-name\""+(_vm._ssrAttr("value",(_vm.informationObj.full_name)))+" class=\"form-control\" data-v-3ce62402></div> <div class=\"mb-3\" data-v-3ce62402><label for=\"phonenumber\" class=\"col-form-label\" data-v-3ce62402>شماره تلفن همراه:</label> <input type=\"tel\" id=\"phonenumber\""+(_vm._ssrAttr("value",(_vm.informationObj.phone_number)))+" class=\"form-control\" data-v-3ce62402></div></form></div> <div class=\"modal-footer\" data-v-3ce62402><button type=\"button\""+(_vm._ssrAttr("disabled",_vm.makeButtonLoading))+(_vm._ssrAttr("loading",_vm.makeButtonLoading))+" class=\"btn btn-primary\" data-v-3ce62402>"+_vm._ssrEscape("\n            "+_vm._s(!_vm.makeButtonLoading ? 'ثبت نام' : 'کمی صبر کنید...')+"\n          ")+"</button></div></div></div></div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/newslettersPopup.vue?vue&type=template&id=3ce62402&scoped=true&
...
//
//
/* harmony default export */ var newslettersPopupvue_type_script_lang_js_ = ({name:"newslettersPopup",data(){return{informationObj:{full_name:'',phone_number:''},makeButtonLoading:false};},methods:{async checkAndRegisterInNewsletter(e){e.preventDefault();if(this.informationObj.full_name.trim()==='')return this.$notify({title:"خطا!",text:'لطفا نام و نام خانوادگی خود را وارد کنید.',type:'error'});if(this.informationObj.phone_number.trim()==='')return this.$notify({title:"خطا!",text:'لطفا شماره تلفن همراه خود را وارد کنید.',type:'error'});if(this.informationObj.phone_number.length!==11)return this.$notify({title:"خطا!",text:"لطفا شماره تلفن همراه خود رابه درستی وارد کنید.",type:'error'});this.makeButtonLoading=true;await this.$axios.post('/add_new_receiver',this.informationObj).then(response=>{this.makeButtonLoading=false;return this.$notify({title:"سپاس از مشارکت شما!",text:response.data.msg,type:'success'});}).catch(()=>{this.makeButtonLoading=false;return this.$notify({title:"عملیات ناموفق!",text:"خطایی در ثبت اطلاعات رخ داد.",type:'error'});});}},mounted(){document.getElementById('newsletterPopUpButton').click();}});
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=7f9b8818&
...
// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=7f9b8818&
...
//
//
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({components:{NewslettersPopup:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 114)),TheHeader:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 60)),HeroSlider:()=>__webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, 107)),ServicePolicy:()=>__webpack_require__.e(/* import() */ 3).then(__webpack_require__.bind(null, 86)),ProductWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 73)),BlogWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 67)),TestimonialOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 69)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53)),NewsletterStyleOne:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 65))},head(){return{title:'فروشگاه ساخت ایران',meta:[{hid:'فروشگاه خط تولید',name:'فروشگاه ساخت ایران',content:'فروشگاه خط تولید ساخت ایران'}]};}});
...
installComponents(component, {NewslettersPopup: __webpack_require__(114).default,TheHeader: __webpack_require__(60).default,HeroSlider: __webpack_require__(115).default,ProductWrapper: __webpack_require__(73).default,BlogWrapper: __webpack_require__(67).default,TestimonialOne: __webpack_require__(69).default,NewsletterStyleOne: __webpack_require__(65).default,TheFooter: __webpack_require__(53).default})
...
//
//
/* harmony default export */ var TheFootervue_type_script_lang_js_ = ({data(){return{informationObj:{full_name:'',phone_number:''},makeButtonLoading:false};},methods:{async checkAndRegisterInNewsletter(e){e.preventDefault();if(this.informationObj.full_name.trim()==='')return this.$notify({title:"خطا!",text:'لطفا نام و نام خانوادگی خود را وارد کنید.',type:'error'});if(this.informationObj.phone_number.trim()==='')return this.$notify({title:"خطا!",text:'لطفا شماره تلفن همراه خود را وارد کنید.',type:'error'});if(this.informationObj.phone_number.length!==11)return this.$notify({title:"خطا!",text:"لطفا شماره تلفن همراه خود رابه درستی وارد کنید.",type:'error'});this.makeButtonLoading=true;await this.$axios.post('/add_new_receiver',this.informationObj).then(response=>{this.makeButtonLoading=false;return this.$notify({title:"سپاس از مشارکت شما!",text:response.data.msg,type:'success'});}).catch(()=>{this.makeButtonLoading=false;return this.$notify({title:"عملیات ناموفق!",text:"خطایی در ثبت اطلاعات رخ داد.",type:'error'});});}}});
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/product/ProductGridItem.vue?vue&type=template&id=ee9f4be4&
...
// CONCATENATED MODULE: ./components/product/ProductGridItem.vue?vue&type=template&id=ee9f4be4&
...
//
//
/* harmony default export */ var BlogWrappervue_type_script_lang_js_ = ({components:{BlogItem:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 66))},data(){return{blogs:[]};},async mounted(){const blog=await this.$axios.get('/blogs-random');this.blogs=blog.data;}});
...
/* nuxt-component-imports */
installComponents(component, {SectionTitleWithSubTitle: __webpack_require__(58).default,BlogItem: __webpack_require__(66).default})
